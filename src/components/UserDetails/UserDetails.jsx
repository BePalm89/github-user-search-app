      ...
      <div className="user-details">
        ...
        <div className="row-info-box">
          ...
          <div className="row-info">
            ...
            <p className="bold-text">{user.followers}</p>
          </div>
          <div className="row-info">
        ...
        <div className="info-details-wrapper">
          <div className="row-info-column">
            <div className="info-details">
              <svg
                className={
                  user.location ? "icon-available" : "icon-not-available"
                }
                height="20"
                width="14"
            ...
            <div className="info-details">
              <svg
                className={user.blog ? "icon-available" : "icon-not-available"}
                height="20"
                width="20"
                xmlns="http://www.w3.org/2000/svg"
              >
          ...
          <div className="row-info-column">
            ...
            <div className="info-details">
              <svg
                className={
                  user.company ? "icon-available" : "icon-not-available"
                }
                height="20"
                width="20"
                xmlns="http://www.w3.org/2000/svg"
