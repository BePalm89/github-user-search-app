      ...
      <div className="user-details">
        ...
        <RowInfoBox>
          <div className="row-info">
            ...
            <p className="bold-text">{public_repos}</p>
          </div>
          <div className="row-info">
            <p className="light-title">Followers</p>
            <p className="bold-text">{followers}</p>
          </div>
          <div className="row-info">
            <p className="light-title">Following</p>
            <p className="bold-text">{following}</p>
          </div>
        </RowInfoBox>
        ...
        <div className="info-details-wrapper">
          <div className="row-info-column">
            <div className="info-details">
              <svg
                className={location ? "icon-available" : "icon-not-available"}
                height="20"
                width="14"
            ...
            <div className="info-details">
              <svg
                className={blog ? "icon-available" : "icon-not-available"}
                height="20"
                width="20"
                xmlns="http://www.w3.org/2000/svg"
              >
          ...
          <div className="row-info-column">
            <div className="info-details">
              <svg
                className={
                  twitter_username ? "icon-available" : "icon-not-available"
                }
                height="18"
                width="20"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="info-details">
              <svg
                className={company ? "icon-available" : "icon-not-available"}
                height="20"
                width="20"
                xmlns="http://www.w3.org/2000/svg"
              >
